Pod::Spec.new do |s|
  ...
  s.source       = { :git => "git@github.com:floschliep/IntegrationTest.git", :tag => s.version }
  
  s.source_files  = ["IntegratedFramework/*.swift", "IntegratedFramework/IntegratedFramework.h"]
